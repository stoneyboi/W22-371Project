<template>
	<div class="home">
			...
			<div id="right">
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<button id="logout-btn" v-on:click="signout()">Log Out</button>
					</div>
				</div>
		...
		-->
			<div class="main">
				<div class="write">
					<textarea rows="3" placeholder="What's Cookin' Good Lookin'?"></textarea>
				</div>
			</div>
			...
			<div class="divRight">
				...
				<div class="example">
					...
					<div class="Rtitle">
						<h3>Ricotta and Arugula Peach Pizza</h3>
						<span>Quick</span>
					</div>
